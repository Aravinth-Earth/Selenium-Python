...
if the_browser_to_go == 'chrome':
    driver = webdriver.Chrome(os.path.join(project_folder_path,
                                           'browser-drivers\\chromedriver_win32\\chromedriver.exe'))
elif the_browser_to_go == 'edge':
    driver = webdriver.Edge(os.path.join(project_folder_path,
                                         'browser-drivers\\edgedriver_win64\\msedgedriver.exe'))
# load-site
